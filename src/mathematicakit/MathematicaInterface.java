...
public class MathematicaInterface implements SolverInterface {
...
// Basic way to do "quantifier elimination"
	public SolverResult checkValidity( String filename, dLFormula thisFormula, String comment ) throws Exception {
		...
		queryFileWriter.println( comment );

		queryFileWriter.println("Reduce[\n");
...
// Basic way to find an instance
	public SolverResult findInstance( String filename, List<dLFormula> theseFormulas, String comment ) 
		...
		queryFileWriter.println("Flatten[ FindInstance[\n");
...
// this is so I can keep track of what each query does
	public String generateFindInstanceComment( List<dLFormula> theseFormulas ) {
		Date date = new Date();
		String comment = "(* Automatically generated by Perseus on " + date.toString() + " *)\n\n";
		comment = comment + "(* Find a valuation of variables that satisfies the formulas: *)\n";
		Iterator<dLFormula> formulaIterator = theseFormulas.iterator();
		int counter = 1;
		while ( formulaIterator.hasNext() ) {
	...
	public String generateCheckValidityComment( List<dLFormula> theseFormulas ) {
		Date date = new Date();
		String comment = "(* Automatically generated by Perseus on " + date.toString() + " *)\n\n";
		comment = comment + "(* Check the (conjunctive) validity of: *)\n";
		Iterator<dLFormula> formulaIterator = theseFormulas.iterator();
		int counter = 1;
		while ( formulaIterator.hasNext() ) {
			comment = comment + "(* Formula " + counter + ": *)\n";
